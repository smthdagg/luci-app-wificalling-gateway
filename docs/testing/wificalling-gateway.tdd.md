...
- GREEN: the final v1.0 runner executes 21 tests successfully, covering all five user journeys plus invalid protocol, duplicate IP, non-private IP, unrelated-device traffic, high-volume active traffic, PassWall bypass, package format, release metadata, documentation, and LuCI regressions.
