...
- OpenWrt / ImmortalWrt / iStoreOS with firewall4 and nftables.
...
|---|---|---|
| `luci-app-wificalling-gateway_1.5.0-1_all.ipk` | OpenWrt / ImmortalWrt / iStoreOS **24.10 line** | Real router (ImmortalWrt 24.10.6), official 24.10.8 rootfs, iStoreOS 24.10 |
| `luci-app-wificalling-gateway_1.5.0-r1_noarch.apk` | OpenWrt / ImmortalWrt **25.12 line, all chips** | x86_64 / aarch64 / armv7 / mipsel (official 25.12.3 rootfs) |
...
Dependencies (luci-base, sing-box, firewall4, kmod-nft-tproxy, kmod-nft-socket, ip-full) are resolved automatically from the official feed.
