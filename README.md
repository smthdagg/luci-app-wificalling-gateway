...
>
> 运营商要求设备定位与其服务区一致（如英国运营商需定位在英国）才能激活 Wi-Fi Calling。本插件通过英国节点提供英国 IP，但**设备自身的 GPS / 蜂窝基站定位仍可能报告其他位置**，导致 Wi-Fi Calling 无法触发。
>
> **解决方法**：在 iPhone 上开启**飞行模式 + Wi-Fi**，使 iOS 关闭蜂窝和 GPS 后回退到 IP 定位（走英国节点 = 英国定位），满足运营商检查。开着蜂窝时基站定位可能报告非英国位置，Wi-Fi Calling 不触发。
